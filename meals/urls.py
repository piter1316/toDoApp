...
urlpatterns = [
    ...
    path('mealsList/1/edit_extras/<meals_list_id>', views.edit_extras, name='edit_extras'),
    ...
    path('ingredientsEdit/editDivisionPriority/<division_id>', views.edit_division_priority, name='edit_division_priority'),
